...
import 'bootstrap/scss/bootstrap.min.scss';
...
const citiesByCountries = {
    sa: ['الرياض', 'جدة', "مكة", 'المدينة المنورة', 'تبوك', 'الدمام', 'الجبيل', 'الخبر', 'الطائف'],
    eg: ['القاهرة', 'الاسكندرية', 'الشرقية', 'الاسماعيلية', 'المنوفية', 'كفر الشيخ', 'أسوان', 'أسيوط', 'بني سويف', 'البحر الأحمر', 'سوهاج', 'الدقهلية', 'الأقصر', 'البحيرة', 'جنوب سيناء', 'السويس', 'الفيوم', 'القليوبية', 'قنا', 'المنيا', 'الوادي الجديد'],
    jo: ['الزرقاء', 'عمان'],
    sy: ['حماء', 'حلب', 'دمشق']
}
...
document.getElementById("copyright").innerHTML = " جميع الحقوق محفوظة لهذا المتجر " + new Date().getFullYear();